...
def purchase_product(*, user_id: int, product_id: int, quantity: int = 1) -> PurchaseResult:
    ...
    with transaction.atomic():
        ...
        order = Order.objects.create(
            ...
            delivered_payload="\n\n".join(item.secret_content for item in stock_items),
        )
